...
│   │   ├── services/           # Business services, composers
...
- **Specific Handling Patterns:**
  ...
  - Transaction Management: {Approach to ensure data consistency in case of errors during multi-step operations, e.g., database transactions (specify isolation levels if non-default), Saga pattern for distributed transactions (specify composer/choreography and compensation logic).}
